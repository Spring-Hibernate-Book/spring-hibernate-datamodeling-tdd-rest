...
function isPresent(){
	...
	if(null != clientid && "" != clientid && null!= accountid && "" != accountid) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanybidirectional/clientaccount/mock/isPresent",
			type: "POST",
...
function createClientAccount(clientid, accountid, clientname, accountnumber){
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectional/clientaccount/mock/create",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function createClient(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanybidirectional/client/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createAccount(){
	...
	if(null != number && "" != number) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanybidirectional/account/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateClient(){
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectional/client/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateAccount(){
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectional/account/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectional/client/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectional/account/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectional/clientaccount/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteClientObject(clientid){
	...
	delurl="/Spring-OODD/manytomanybidirectional/client/mock/remove/"+clientid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : clientForm,
...
function deleteAccountObject(accountid){
	...
	delurl="/Spring-OODD/manytomanybidirectional/account/mock/remove/"+accountid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : accountForm,
...
function deleteClientAccountObject(clientid,accountid){
	var formData={"clientDto":{"id":clientid},"accountDto":{"id":accountid}};
	delurl="/Spring-OODD/manytomanybidirectional/clientaccount/mock/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editClientObject(clientid){
	editurl="/Spring-OODD/manytomanybidirectional/client/mock/findById/"+clientid;
	var clientForm={id:clientid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editAccountObject(accountid){
	editurl="/Spring-OODD/manytomanybidirectional/account/mock/findById/"+accountid;
	var accountForm={id:accountid};
	$.ajax({
		url : editurl,
		type: "GET",
