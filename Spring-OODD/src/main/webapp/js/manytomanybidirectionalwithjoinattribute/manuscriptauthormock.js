...
function isPresent(){
	...
	if(null != manuscriptid && "" != manuscriptid && null!= authorid && "" != authorid && null!= publisher && "" != publisher) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscriptauthor/mock/isPresent",
			type: "POST",
...
function createManuscript(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscript/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createAuthor(){
	...
	if(null != name && "" != name) {
		var formData={"name":name};
		$.ajax({
			url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/author/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateManuscript(){
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscript/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateAuthor(){
	...
	var formData={"id":id,"name":name};
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/author/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscript/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/author/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscriptauthor/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteManuscriptObject(manuscriptid){
	...
	delurl="/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscript/mock/remove/"+manuscriptid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : manuscriptForm,
...
function deleteAuthorObject(authorid){
	...
	delurl="/Spring-OODD/manytomanybidirectionalwithjoinattribute/author/mock/remove/"+authorid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : authorForm,
...
function deleteManuscriptAuthorObject(manuscriptid,authorid){
	...
	delurl="/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscriptauthor/mock/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editManuscriptObject(manuscriptid){
	editurl="/Spring-OODD/manytomanybidirectionalwithjoinattribute/manuscript/mock/findById/"+manuscriptid;
	var manuscriptForm={id:manuscriptid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editAuthorObject(authorid){
	editurl="/Spring-OODD/manytomanybidirectionalwithjoinattribute/author/mock/findById/"+authorid;
	var authorForm={id:authorid};
	$.ajax({
		url : editurl,
		type: "GET",
