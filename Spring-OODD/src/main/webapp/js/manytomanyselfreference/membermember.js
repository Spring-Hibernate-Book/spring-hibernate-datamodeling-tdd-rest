...
function isPresent(){
	...
	if(null != memberid1 && "" != memberid1 && null!= memberid2 && "" != memberid2) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanyselfreference/membermember/isPresent",
			type: "POST",
...
function createMemberMember(memberid1,memberid2){
	...
	if(memberid1 != memberid2) {
		$.ajax({
			url : "/Spring-OODD/manytomanyselfreference/membermember/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createMember(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanyselfreference/member/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateMember(){
	...
	$.ajax({
		url : "/Spring-OODD/manytomanyselfreference/member/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/manytomanyselfreference/member/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanyselfreference/membermember/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteMemberObject(memberid){
	...
	delurl="/Spring-OODD/manytomanyselfreference/member/remove/"+memberid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : memberForm,
...
function deleteMemberMemberObject(memberid1,memberid2){
	var formData={"memberId1":{"id":memberid1},"memberId2":{"id":memberid2}};
	delurl="/Spring-OODD/manytomanyselfreference/membermember/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editMemberObject(memberid){
	editurl="/Spring-OODD/manytomanyselfreference/member/findById/"+memberid;
	var memberForm={id:memberid};
	$.ajax({
		url : editurl,
		type: "GET",
