...
function isPresent(){
	...
	if(null != workerid1 && "" != workerid1 && null!= workerid2 && "" != workerid2 && null!= relationshipType && "" != relationshipType) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanyselfreferencewithjoinattribute/workerworker/mock/isPresent",
			type: "POST",
...
function createWorkerWorker(workerid1,workerid2,relationshipType,workername1,workername2){
	...
	if(workerid1 != workerid2) {
		$.ajax({
			url : "/Spring-OODD/manytomanyselfreferencewithjoinattribute/workerworker/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createWorker(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanyselfreferencewithjoinattribute/worker/mock/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateWorker(){
	...
	$.ajax({
		url : "/Spring-OODD/manytomanyselfreferencewithjoinattribute/worker/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/manytomanyselfreferencewithjoinattribute/worker/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanyselfreferencewithjoinattribute/workerworker/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteWorker(workerid){
	...
	delurl="/Spring-OODD/manytomanyselfreferencewithjoinattribute/worker/mock/remove/"+workerid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : workerForm,
...
function deleteWorkerWorker(workerid1,workerid2){
	var formData={"workerId1":{"id":workerid1},"workerId2":{"id":workerid2}};
	delurl="/Spring-OODD/manytomanyselfreferencewithjoinattribute/workerworker/mock/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editWorker(workerid){
	editurl="/Spring-OODD/manytomanyselfreferencewithjoinattribute/worker/mock/findById/"+workerid;
	var workerForm={id:workerid};
	$.ajax({
		url : editurl,
		type: "GET",
