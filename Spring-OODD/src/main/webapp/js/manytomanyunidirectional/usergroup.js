...
function isPresent(){
	...
	if(null != userid && "" != userid && null!= groupid && "" != groupid) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanyunidirectional/usergroup/isPresent",
			type: "POST",
...
function createUserGroup(userid,groupid){
	var formData={"userDto":{"id":userid},"groupDto":{"id":groupid}};
	$.ajax({
		url : "/Spring-OODD/manytomanyunidirectional/usergroup/create",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function createUser(){
	...
	if(null != name && "" != name) {
		...
		$.ajax({
			url : "/Spring-OODD/manytomanyunidirectional/user/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function createGroup(){
	...
	if(null != name && "" != name) {
		var formData={"name":name};
		$.ajax({
			url : "/Spring-OODD/manytomanyunidirectional/group/create",
			type: "POST",
			data : JSON.stringify(formData),
			beforeSend: function(xhr) {
				xhr.setRequestHeader("Accept", "application/json");
...
function updateUser(){
	...
	$.ajax({
		url : "/Spring-OODD/manytomanyunidirectional/user/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function updateGroup(){
	...
	var formData={"id":id,"name":name};
	$.ajax({
		url : "/Spring-OODD/manytomanyunidirectional/group/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/manytomanyunidirectional/user/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanyunidirectional/group/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
	...
	$.ajax({
		url : "/Spring-OODD/manytomanyunidirectional/usergroup/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteUserObject(userid){
	...
	delurl="/Spring-OODD/manytomanyunidirectional/user/remove/"+userid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : userForm,
...
function deleteGroupObject(groupid){
	...
	delurl="/Spring-OODD/manytomanyunidirectional/group/remove/"+groupid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : groupForm,
...
function deleteUserGroupObject(userid,groupid){
	var formData={"userDto":{"id":userid},"groupDto":{"id":groupid}};
	delurl="/Spring-OODD/manytomanyunidirectional/usergroup/remove";
	$.ajax({
		url : delurl,
		type: "POST",
		data : JSON.stringify(formData),
...
function editUserObject(userid){
	editurl="/Spring-OODD/manytomanyunidirectional/user/findById/"+userid;
	var userForm={id:userid};
	$.ajax({
		url : editurl,
		type: "GET",
...
function editGroupObject(groupid){
	editurl="/Spring-OODD/manytomanyunidirectional/group/findById/"+groupid;
	var groupForm={id:groupid};
	$.ajax({
		url : editurl,
		type: "GET",
