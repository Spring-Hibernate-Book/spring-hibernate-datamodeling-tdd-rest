...
function create(){
	...
	$.ajax({
		url : "/Spring-OODD/onetomanyselfreference/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/Spring-OODD/onetomanyselfreference/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function deleteObject(Id){
	...
	delurl="/Spring-OODD/onetomanyselfreference/remove/"+Id;
	$.ajax({
		url : delurl,
		type: "POST",
		data : productForm,
...
function editObject(Id){
	editurl="/Spring-OODD/onetomanyselfreference/findById/"+Id;
	var itemForm={id:Id};
	$.ajax({
		url : editurl,
		type: "GET",
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/onetomanyselfreference/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
