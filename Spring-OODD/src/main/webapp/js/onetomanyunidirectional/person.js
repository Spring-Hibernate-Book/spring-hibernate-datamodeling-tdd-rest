...
function create(){
	...
	$.ajax({url : "/Spring-OODD/onetomanyunidirectional/create",type: "POST",
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/onetomanyunidirectional/findAll",type: "GET",data : {},dataType: "json",
...
function deleteObject(personid){
	...
	delurl="/Spring-OODD/onetomanyunidirectional/remove/"+personid;
...
function update(){
	...
	$.ajax({
		url : "/Spring-OODD/onetomanyunidirectional/edit",
		type: "POST",
...
function editObject(personid){
	editurl="/Spring-OODD/onetomanyunidirectional/findById/"+personid;
	var customerForm={id:personid};
