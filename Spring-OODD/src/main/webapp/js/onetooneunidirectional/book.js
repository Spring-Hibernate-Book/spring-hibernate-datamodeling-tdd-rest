...
function create(){
	...
	$.ajax({
		url : "/Spring-OODD/onetooneunidirectional/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/Spring-OODD/onetooneunidirectional/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/onetooneunidirectional/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(bookId){
	...
	delurl="/Spring-OODD/onetooneunidirectional/remove/"+bookId;
	$.ajax({
		url : delurl,
		type: "POST",
		data : productForm,
...
function editObject(bookId){
	editurl="/Spring-OODD/onetooneunidirectional/findById/"+bookId;
	var productForm={id:bookId};
	$.ajax({
		url : editurl,
		type: "GET",
