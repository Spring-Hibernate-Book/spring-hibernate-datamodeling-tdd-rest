...
public class MemberControllerTest {
	...
	public void testCreate() throws Exception {
		...
		memberDto.setName("Leticia Baker");
		
		String json = gson.toJson(memberDto);
		
		MockHttpServletRequestBuilder requestBuilderOne = MockMvcRequestBuilders.post("/manytomanyselfreference/member/create");
	...
	public void testUpdate() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder2 = MockMvcRequestBuilders.get("/manytomanyselfreference/member/findAll");
		...
		List<MemberDto> memberDtoList = gson.fromJson(response2, listType);
		MemberDto memberDto2 = memberDtoList.get(0);
		memberDto2.setName("Amritendu De");
		
		String json2 = gson.toJson(memberDto2);
		MockHttpServletRequestBuilder requestBuilder3 = MockMvcRequestBuilders.post("/manytomanyselfreference/member/edit");
	...
	public void testDelete() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder3 = MockMvcRequestBuilders.post("/manytomanyselfreference/member/remove/"+memberDto2.getId());
		requestBuilder3.contentType(MediaType.APPLICATION_JSON);
