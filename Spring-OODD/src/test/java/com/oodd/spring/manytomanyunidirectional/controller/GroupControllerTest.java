...
public class GroupControllerTest {
	...
	public void testCreate() throws Exception {
		...
		String json = gson.toJson(groupDto);
		
		MockHttpServletRequestBuilder requestBuilderOne = MockMvcRequestBuilders.post("/manytomanyunidirectional/group/create");
	...
	public void testUpdate() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder2 = MockMvcRequestBuilders.get("/manytomanyunidirectional/group/findAll");
		...
		List<GroupDto> groupDtoList = gson.fromJson(response2, listType);
		GroupDto groupDto2 = groupDtoList.get(0);
		groupDto2.setName("DEF");

		String json2 = gson.toJson(groupDto2);
		MockHttpServletRequestBuilder requestBuilder3 = MockMvcRequestBuilders.post("/manytomanyunidirectional/group/edit");
	...
	public void testDelete() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder3 = MockMvcRequestBuilders.post("/manytomanyunidirectional/group/remove/"+groupDto2.getId());
		requestBuilder3.contentType(MediaType.APPLICATION_JSON);
