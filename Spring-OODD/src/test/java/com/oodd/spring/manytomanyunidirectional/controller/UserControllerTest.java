...
public class UserControllerTest {
	...
	public void testCreate() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilderOne = MockMvcRequestBuilders.post("/manytomanyunidirectional/user/create");
	...
	public void testUpdate() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder2 = MockMvcRequestBuilders.get("/manytomanyunidirectional/user/findAll");
		...
		List<UserDto> userDtoList = gson.fromJson(response2, listType);
		UserDto userDto2 = userDtoList.get(0);
		userDto2.setName("DEF");

		String json2 = gson.toJson(userDto2);
		MockHttpServletRequestBuilder requestBuilder3 = MockMvcRequestBuilders.post("/manytomanyunidirectional/user/edit");
	...
	public void testDelete() throws Exception {
		...
		MockHttpServletRequestBuilder requestBuilder3 = MockMvcRequestBuilders.post("/manytomanyunidirectional/user/remove/"+userDto2.getId());
		requestBuilder3.contentType(MediaType.APPLICATION_JSON);
